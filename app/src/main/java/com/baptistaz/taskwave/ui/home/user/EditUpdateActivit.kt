...
class EditUpdateActivity : AppCompatActivity() {
    ...
    override fun onCreate(b: Bundle?) {
        ...
        supportActionBar?.title = "Edit Update"
        ...
        findViewById<MaterialButton>(R.id.button_add_update)      // mesmo id
            .apply { text = "Edit Update" }                       // muda texto
            .setOnClickListener {
                val edited = upd.copy(
                ...
                lifecycleScope.launch {
                    ...
                    Toast.makeText(this@EditUpdateActivity,"Saved!",Toast.LENGTH_SHORT).show()
                    finish()
                }
            }
    }
