...
/**
 * Activity for a Manager to create a new Task within a specific project.
 */
class ManagerCreateTaskActivity : BaseLocalizedActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Enable date picker for conclusion date
        ...
        // Load available users (only normal users, not managers and admins)
        ...
        buttonCreate.setOnClickListener {
            ...
            // API call to create task and assign user
            lifecycleScope.launch {
                try {
    ...
    /**
     * Opens a DatePickerDialog and returns the selected date formatted as YYYY-MM-DD
     */
